...
typedef struct context {
    ...
    int block_enqueue_time;     /* time at which process was added to block queue */
    ...
    int send_count;             /* counter to increment send */
    int recv_count;             /* counter to increment receive */
} context;
...
/* Returns the current arguments being executed
 * @params:
 *  cur: pointer to process context
 * @returns:
 *  the primitive being executed
 */
extern int context_cur_arg(context *cur);
